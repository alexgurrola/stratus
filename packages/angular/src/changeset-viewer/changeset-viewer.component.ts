...
// @Injectable()
export class ChangesetViewerComponent extends RootComponent implements OnInit, OnChanges {
    ...
    constructor(
        ...
        this.hydrate(this.elementRef, this.sanitizer, keys<ChangesetViewerComponent>())
    }
